            ...
            <div class="row-header">
                ...
                @foreach($products as $product_element)
                    <div class="table-row swipe-element">
                        ...
                        <div class="table-field-container swipe-front">
                            <div class="table-field column">{{$product_element->pricing->price}}</div>
                        </div>
                        <div class="table-icons-container swipe-back column">
                            <div class="table-icons edit-button right-swipe" data-url="{{route('products_edit', ['faq' => $faq_element->id])}}">
...
@section('form')
    ...
    {{-- @include('admin.layout.errors') --}}
        ...
        <div class="form-content">
            ...
            <form class="admin-form" id="products-form" action="{{route("productss_store")}}" autocomplete="off">
                ...
                <div class="tabs-container">
                    <div class="tabs-container-menu">
                        <ul>
                            ...
                            <li class="tab-item tab-active" data-tab="sizes">
                                Tallas
                            </li>    
                            <li class="tab-item tab-active" data-tab="colours">
                                Colores
                            </li>  
                            <li class="tab-item tab-active" data-tab="pricing">
                                Precios
                            </li>    
                            ...
                            <div class="form-input">
                                <select name="category_id" data-placeholder="Seleccione una categoría" class="input-highlight">
                                    ...
                                    @foreach($products_categories as $product_category)
                                        <option value="{{$product_category->id}}" {{$product->category_id == $product_category->id ? 'selected':''}} class="category_id">{{ $product_category->name }}</option>
                                    @endforeach
                                </select>                   
                            </div>
                        </div>
            ...
            <div class="locale-tab-panel {{ $loop->first ? 'locale-tab-active':'' }}" data-tab="content" data-localetab="{{$localization->alias}}">
                ...
                <div class="one-column">
                    <div class="form-group">
                        ...
                        <div class="form-input">
                            <input type="text" name="specification[material.{{$localization->alias}}]" value="{{isset($specification["material.$localization->alias"]) ? $specification["material.$localization->alias"] : ''}}" class="input-highlight">
                        </div>
                    </div>
                </div>
                ...
                <div class="one-column">
                    <div class="form-group">
                        ...
                        <div class="form-input">
                            <input type="text" name="specification[product_number.{{$localization->alias}}]" value="{{isset($specification["product_number.$localization->alias"]) ? $specification["product_number.$localization->alias"] : ''}}" class="input-highlight">
                        </div>
                    </div>
                </div>
                ...
                <div class="one-column">
                    <div class="form-group">
                        ...
                        <div class="form-input">
                            <input type="text" name="specification[designer.{{$localization->alias}}]" value="{{isset($specification["designer.$localization->alias"]) ? $specification["designer.$localization->alias"] : ''}}" class="input-highlight">
                        </div>
                    </div>
                </div>
...
@foreach ($localizations as $localization)
    ...
    <div class="locale-tab-panel {{ $loop->first ? 'locale-tab-active':'' }}" data-tab="content" data-localetab="{{$localization->alias}}">
        ...
        <div class="one-column">
            <div class="form-group">
                <div class="form-label">
                    <label for="material" class="label-highlight">Precio</label>
                </div>
                <div class="form-input">
                    <input type="text" name="specification[material.{{$localization->alias}}]" value="{{isset($specification["material.$localization->alias"]) ? $specification["material.$localization->alias"] : ''}}" class="input-highlight">
                </div>
