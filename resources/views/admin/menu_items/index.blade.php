    ...
    @foreach ($localizations as $localization)
        ...
        <div class="locale-tab-panel {{ $loop->first ? 'locale-tab-active':'' }}" data-tab="content" data-localetab="{{$localization->alias}}">
            ...
            <div class="one-column">
                <div class="form-group">
                    <div class="form-label">
                        <label>
                            <button class="menu-item-create" data-url="{{route('menus_item_create')}}" data-menu="{{$menu->id}}" data-language="{{$localization->alias}}"> Aquí </button>
            ...
            @if($menu->parent_items->count() > 0)
                ...
                <div class="one-column">
                    <div class="form-group">
                        @include('admin.layout.items_nestables', [
