        ...
        <form class="admin-form" id="business-information-form" action="{{route("business_information_store")}}" autocomplete="off">
            ...
            <div class="tabs-container">
                ...
                <div class="form-buttons">
                    <div class="visible">
                        <label class="switch">
                            <input type="checkbox" name="visible" checked="checked" value="{{ isset($business->visible) ? $business->visible : '1' }}"  class="input" id="switch">
            ...
            <div class="tab-panel" data-tab="logo">
                ...
                @component('admin.layout.locale', ['tab' => 'logo'])
            ...
            <div class="tab-panel" data-tab="socials">
                ...
                @component('admin.layout.locale', ['tab' => 'socials'])
            ...
            <div class="tab-panel" data-tab="presentation">
                ...
                @component('admin.layout.locale', ['tab' => 'presentation'])
