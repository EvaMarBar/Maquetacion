    ...
    <table>
        ...
        @foreach($faqs as $faq)
            <tr>
                ...
                <td>
                    <svg class="table-icons" style="width:24px;height:24px" viewBox="0 0 24 24">
...
<div class="form_content">
    ...
    <form class="admin-form" id="faqs-form" action="{{route("faqs_store")}}" autocomplete="off">
        ...
        <div class="form_group">
            ...
            <div class="form_input">
                <textarea name="description" value="{{isset($faq->description) ? $faq->description : ''}}" class="input" rows="5"></textarea>
            </div>
        </div>
    </form>
</div>
