            ...
            @foreach ($filters as $key => $items)
                ...
                @if($key == 'designer')
                    <div class="one-column-filter">
                        <div class="form-group">
                            <div class="form-label">
                                <label for="designer" class="label-highlight">Filtrar por diseñador</label>
                            </div>
                            <div class="form-input">
                                <select name="designer" data-placeholder="Seleccione un diseñador" class="input-highlight">
                                    <option value="all">Todas</option>
                                    @foreach($items as $item)
                                        <option value="{{$item->id}}">{{ $item->name }}</option>
                                    @endforeach
